    ...
    <div>
      ...
      <div className="border-2 mt-10 ml-96 mr-96 rounded-xl p-16 drop-shadow-xl ">
        <div className="bg-gray-400 h-2 rounded-xl">
          <div
            className="style={{ width: '30px', height: '20px', marginRight: '8px' }} h-full  rounded-xl"
...
Please select the option that best represents your eating pattern:</p>
        ...
        <div className="flex justify-around mt-10 ml-5 mr-5">
          <Link className="bg-green-400  text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/healthy-fats"}>Back</Link>
          {isFieldFilled ? (
            <Link className="bg-green-400 text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/ActivityLevel"} onClick={handleNext}>Next</Link>
          ) : (
