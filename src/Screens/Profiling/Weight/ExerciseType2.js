    ...
    <div>
      ...
      <div className="border-2  mt-10 ml-96 mr-96 rounded-xl p-16 drop-shadow-xl ">
        ...
        <div className="flex justify-around mt-10 ml-5 mr-5">
          <Link className="bg-green-400 text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/eat-before-workout2"}>Back</Link>
          {isExerciseTypeSelected ? (
            <Link className="bg-green-400 text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/workout-frequency2"} onClick={handleNext}>Next</Link>
          ) : (
