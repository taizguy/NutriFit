...
const DailyMealNo = () => {
  ...
  return (
    <div>
      <div className='bg-green-500 p-8 text-center text-2xl text-white font-bold'>Eating Habits</div>
...
Please select the option that best represents your eating pattern:</p>
        ...
        <div className="flex justify-around mt-10 ml-5 mr-5">
          <Link className="bg-green-400  text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/HealthyFatsNo"}>Back</Link>
          {isFieldFilled ? (
            <Link className="bg-green-400 text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/ActivityLevelNo"} onClick={handleNext}>Next</Link>
          ) : (
