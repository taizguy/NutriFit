...
const Sqs2 = () => {
  ...
  return (
    <div>
      <div className='bg-green-400 p-8 text-center text-2xl text-white font-bold'>Schedule</div>
      ...
      That's why we're here to provide insights, share experiences, and answer your burning questions about how to strike that perfect harmony.</p>      
        <div className="flex justify-around mt-10 ml-5 mr-5">
          <Link className="bg-green-400 text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/ActivityLevelNo"}>Back</Link>
          
            <Link className="bg-green-400 text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/SleepTimeNo"} onClick={handleNext}>Next</Link>
