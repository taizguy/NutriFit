    ...
    <div>
      ...
      <div className="mt-10 ml-96 mr-96 rounded-xl p-16 drop-shadow-xl border-2">
        ...
        <div className="flex justify-around mt-10 ml-5 mr-5">
          <Link className="bg-green-400 text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/FoodElergiesNo"}>Back</Link>
          {isAtLeastOneCheckboxSelected ? (
            <Link className="bg-green-400 text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/HealthyFatsNo"} onClick={handleNext}>Next</Link>
          ) : (
