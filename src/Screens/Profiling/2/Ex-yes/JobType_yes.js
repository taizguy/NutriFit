...
const JobType_yes = () => {
  ...
  return (
    <div>
      <div className='bg-green-500 p-8 text-center text-3xl text-white font-bold'>Employment Status</div>
      ...
      <div className="border-2 mt-10 ml-96 mr-96 rounded-xl p-16 drop-shadow-xl ">
        ...
        <div>
          ...
          <div className="text-lg ml-5 mb-5 bg-white rounded-lg p-3 hover:bg-green-400 border-2 border-green-600">
            <Link to="/JobSchedule_yes">Office Job</Link>
          </div>

          <div className="text-lg ml-5 mb-5 bg-white rounded-lg p-3 hover:bg-green-400 border-2 border-green-600">
            <Link to="/PhysicalSchedul_yes">Self Employed</Link>
          </div>
        </div>
        <div className="flex justify-around mt-10 ml-5 mr-5">
          <Link className="bg-green-400  text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/SleepTime_yes"}>Back</Link>
          </div>
      </div>
    </div>
  );
