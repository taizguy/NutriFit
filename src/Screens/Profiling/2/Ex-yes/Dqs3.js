...
const Dqs3 = () => {
  ...
  return (
    <div>
      <div className='bg-green-400 p-8 text-center text-2xl text-white font-bold'>Diet</div>
      ...
      we are dedicated to helping you achieve your health and nutrition goals. Whether you're looking to lose weight, gain muscle, improve your energy levels, or simply adopt a healthier lifestyle, you've come to the right place.</p>
        ...
        <div className="flex justify-around mt-10 ml-5 mr-5">
          <Link className="bg-green-400 text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/play-sport"}>Back</Link>
          
            <Link className="bg-green-400 text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/DietType_yes"} onClick={handleNext}>Next</Link>
