    ...
    <div>
      ...
      <div className="bg-gray-400 h-2 rounded-xl">
        ...
        <div className="flex justify-around mt-10 ml-5 mr-5">
          <Link className="bg-green-400 text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/Dqs3"}>Back</Link>
          {isDietTypeSelected ? (
            <Link className="bg-green-400 text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/FoodElergies_yes"} onClick={handleNext}>Next</Link>
          ) : (
