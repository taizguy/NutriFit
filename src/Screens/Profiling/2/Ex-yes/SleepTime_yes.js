...
const SleepTime_yes = () => {
  ...
  return (
    <div>
      <div className='bg-green-500 p-8 text-center text-2xl text-white font-bold'>Daily Sleep Schedule</div>
      ...
      <div className="bg-gray-400 h-2 rounded-xl">
        ...
        <div className="flex justify-around mt-10 ml-5 mr-5">
          <Link className="bg-green-400  text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/sqs_yes"}>Back</Link>
          {isFieldsFilled ? (
            <Link className="bg-green-400 text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/JobType_yes"} onClick={handleNext}>Next</Link>
          ) : (
