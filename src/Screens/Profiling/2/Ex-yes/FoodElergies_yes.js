...
const FoodElergies_yes = () => {
  ...
  return (
    <div>
      <div className='bg-green-500 p-8 text-center text-2xl text-white font-bold'>Food Allergies</div>
      ...
      <div className="border-2 mt-10 ml-96 mr-96 rounded-xl p-16 drop-shadow-xl">
        ...
        <div className="flex justify-around mt-10 ml-5 mr-5">
          <Link className="bg-green-400 text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/DietType_yes"}>Back</Link>
          {isAtLeastOneCheckboxSelected ? (
            <Link className="bg-green-400 text-white text-xl pl-7 pr-7 pt-1 pb-1" to={"/Protein_yes"} onClick={handleNext}>Next</Link>
          ) : (
...
export default FoodElergies_yes;
