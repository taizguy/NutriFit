...
//                     curSelectedNav === "gym exercise" ? "text-accent-color" : ""
//                   } cursor-pointer`}
...
const Exercises = () => {
  const [totalCalories, setTotalCalories] = useState(200);
    ...
    <div className="max-w-3xl mx-auto p-8">
      ...
      <section className="flex items-center justify-between mb-8">
        ...
        <div className="flex space-x-4">
          ...
          <p>Progress</p>
      <section className="text-center flex justify-between">
        <p className="mb-2">
          Gained Weight: O Kg <MonitorWeightIcon style={{ fontSize: 50 }} />
        </p>
